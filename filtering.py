...
users = {"Angelica": {"Blues Traveler": 3.5, "Broken Bells": 2.0,
         ...
         "Chan": {"Blues Traveler": 5.0, "Broken Bells": 1.0,
                  ...
                  "Slightly Stoopid": 1.0, "Deadmau5": 1.0},
         ...
         "Hailey": {"Broken Bells": 4.0, "Norah Jones": 4.0,
                    "Deadmau5": 1.0, "The Strokes": 4.0,
                    "Vampire Weekend": 1.0},
...
def computeNearestNeighbor(username, users):
    ...
    #sort baesd on distance -- closed first
    distances.sort()
    return distances
...
def recommend(username, users):
    ...
    # using the fn sorted variety -- sort is more efficient
