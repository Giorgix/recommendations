...
def pearson(v1, v2):
    ...
    # 1.0 when two items match perfectly
    # 0.0 when there's no relationship at all
...
def kcluster(rows, distance=pearson, k=4):
    ...
    for t in range(100):
        ...
        # Move the centroids to the averege of their members
        for i in range(k):
            avgs = [0.0] * len(rows[0])
